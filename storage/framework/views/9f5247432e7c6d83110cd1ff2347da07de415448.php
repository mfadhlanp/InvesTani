...
<div class="section">
  ...
  <div class="container">
    ...
    <div class="row">
      ...
      <div style="max-width:300px"><center><h2 class="product-name"><?php echo e($product->nama); ?></h2></br></center></div>
      <!-- Product main img -->
      <div class="col-md-5 col-md-push-2" style="max-width:300px">
      
        <div id="product-main-img" >
          <div class="product-preview">
            <img src="<?php echo e(asset('storage/'.$product->foto1)); ?>" alt="">
          </div>

          <div class="product-preview">
            <img src="<?php echo e(asset('storage/'.$product->foto2)); ?>" alt="">
          </div>

          <div class="product-preview">
            <img src="<?php echo e(asset('storage/'.$product->foto3)); ?>" alt="">
          </div>

          <div class="product-preview">
            <img src="<?php echo e(asset('storage/'.$product->foto4)); ?>" alt="">
          </div>
        </div>
      </div>
      <!-- /Product main img -->
      ...
      <div class="col-md-5">
        ...
        -->
          ...
          <h2>Rp. <?php echo e($result_invest); ?></h2><span class="product-available">
          <h5>terkumpul dari target Rp. <?php echo e($product->target_investasi); ?></h5></br>
      <h2> <?php echo e($product-> keuntungan); ?> %</h2>
      ...
      <h3 class="product-price" style="padding-left:115px;"><?php echo e($product->min_investasi); ?></h3> -->


          </div>
          <form class="form-horizontal form-label-left" action="<?php echo e(route('proyek.investasi', $product->id)); ?>" method="PATCH" enctype="multipart/form-data" novalidate>
          ...
          <div class="add-to-cart">
            <div class="qty-label">
              ...
              <div class="input-number" style="padding-left:28px;">
                <input type="number" id="investasi" onKeyPress="OgKeyPress()" onKeyUp="OgKeyPress()" name="investasi" placeholder="minimal <?php echo e($product->min_investasi); ?>">
              </div>
            </br></br>
            Keuntungan
            <input type="hidden" id="keuntungan" name="keuntungan" value="<?php echo e($product->keuntungan); ?>">
