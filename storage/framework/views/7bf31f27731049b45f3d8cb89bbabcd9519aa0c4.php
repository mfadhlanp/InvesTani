                ...
                <div class="card-body">
                    <form method="POST" action="<?php echo e(route('register')); ?>">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="tanggal_lahir" type="date" class="form-control<?php echo e($errors->has('tanggal_lahir') ? ' is-invalid' : ''); ?>" name="tanggal_lahir" value="<?php echo e(old('tanggal_lahir')); ?>" required autofocus>
