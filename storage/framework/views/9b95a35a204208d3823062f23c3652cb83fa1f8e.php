              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <form class="form-horizontal form-label-left" action="<?php echo e(route('proyek.store')); ?>" method="post" enctype="multipart/form-data" novalidate>
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="nama" class="form-control col-md-7 col-xs-12" value="<?php echo e(old('nama')); ?>" name="nama" placeholder="nama proyek" required="required" type="text">
                        </div>
                      </div>
                      <div class="item form-group">
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <textarea id="lokasi" required="required" name="lokasi"  value="<?php echo e(old('lokasi')); ?>" placeholder="lokasi proyek" class="form-control col-md-7 col-xs-12"></textarea>
                        </div>
                      </div>
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <textarea id="deskripsi" required="required" name="deskripsi"  value="<?php echo e(old('deskripsi')); ?>" placeholder="deskripsi proyek" class="form-control col-md-7 col-xs-12"></textarea>
                        </div>
                      </div>
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="number" id="target_investasi" required="required" name="target_investasi"  value="<?php echo e(old('target_investasi')); ?>" placeholder="Target Investasi" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="number" id="min_investasi" required="required" name="min_investasi"  value="<?php echo e(old('min_investasi')); ?>" placeholder="Minimum Investasi" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="number" id="keuntungan" required="required" name="keuntungan"  value="<?php echo e(old('keuntungan')); ?>" placeholder="Tulis presentase keuntungan (dalam persen)" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="date" id="deadline" required="required" name="deadline"  value="<?php echo e(old('deadline')); ?>" class="form-control col-md-7 col-xs-12"></input>
                        </div>
                      </div>
                      <div class="item form-group">
