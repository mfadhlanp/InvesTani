                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            <li><i class="fa fa-puzzle-piece"></i><a href="{{ route('admin.proyek') }}">Masih berjalan</a></li>
                            <li><i class="fa fa-puzzle-piece"></i><a href="{{ route('admin.proyekKonfirmasi') }}">Konfirmasi</a></li>
                            <li><i class="fa fa-puzzle-piece"></i><a href="{{ route('admin.proyekDone') }}">selesai</a></li>
                    ...
                    <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            <li><i class="fa fa-table"></i><a href="{{route('admin.konfirmasi')}}">Menunggu Konfirmasi</a></li>
                            <li><i class="fa fa-table"></i><a href="{{route('admin.sudahKonfirmasi')}}">Sudah Konfirmasi</a></li>
                        </ul>
                    </li>
                    ...
                    <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            <li><i class="menu-icon fa fa-th"></i><a href="{{route('admin.create')}}">Buat User</a></li>
                            <li><i class="menu-icon fa fa-th"></i><a href="{{ route('admin.member') }}">Daftar User</a></li>
                        </ul>
                    </li>
                    @endif
